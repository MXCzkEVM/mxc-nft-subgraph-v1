...
export class MarketplaceV1__orderByAssetIdResult {
  value0: Bytes;
  value1: Address;
  value2: Address;
  value3: BigInt;
...
export class MarketplaceV1 extends ethereum.SmartContract {
  static bind(address: Address): MarketplaceV1 {
    return new MarketplaceV1("MarketplaceV1", address);
  }
  ...
  orderByAssetId(
    param0: Address,
    param1: BigInt
  ): MarketplaceV1__orderByAssetIdResult {
    let result = super.call(
      "orderByAssetId",
    ...
    return new MarketplaceV1__orderByAssetIdResult(
      result[0].toBytes(),
      result[1].toAddress(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_orderByAssetId(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<MarketplaceV1__orderByAssetIdResult> {
    let result = super.tryCall(
      "orderByAssetId",
      "orderByAssetId(address,uint256):(bytes32,address,address,uint256,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new MarketplaceV1__orderByAssetIdResult(
        value[0].toBytes(),
        value[1].toAddress(),
        value[2].toAddress(),
        value[3].toBigInt(),
